module.exports = {
    ...
    $title[1;User banned!]
    $description[<@$replaceText[$replaceText[$findMember[$message[1];false];<@;];>;]> has beed **banned by <@$authorID>**
    ...
    $onlyIf[$findMember[$message[1]]!=$ownerID;{newEmbed:{description:You can't ban server owner}{color:Red}}]
    ...
    $onlyIf[$hasPerms[$guildID;$authorID;banmembers]==true;{newEmbed:{title:Critical Error}{description:You don't have perms#COLON# \`BAN\`}{color:Red}}]
    $onlyIf[$hasPerms[$guildID;$clientID;banmembers]==true;{newEmbed:{title:Critical Error}{description:I don't have perms#COLON# \`BAN\`}{color:Red}}]
    `
}